# es6-tape-zuul-istanbul-boilerplate [![Build Status](https://travis-ci.org/alexbardas/es6-tape-zuul-istanbul-boilerplate.svg?branch=master)](https://travis-ci.org/alexbardas/es6-tape-zuul-istanbul-boilerplate)
